                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="bg-light p-5 shadow border">
                            <form class="contact-form" id="productForm_1" method="POST" action="<?=base_url('mailer/save_use_template')?>" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
									...
									<input type="hidden" name="id" id="id"  value="<?=!empty(@$get_result->id) ? @$get_result->id : ''?>">
										...
										<?php
										    if(!empty($event)){
												foreach($event as $k => $v){
													echo '<option value="'.@$v->event_id.'" '.((@$get_result->event_id == @$v->event_id) ? 'selected' : '').'>'.@$v->event_name.'</option>';
												}
											}
										?>
									</select>
