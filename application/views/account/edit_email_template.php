                        ...
                        <div class="bg-light p-5 shadow border">
                            <form class="contact-form" id="productForm" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Enter Subject" value="<?=@$result->subject?>">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" placeholder="Event Body" name="body" id="body"><?=@$result->body?></textarea>
                                ...
                                <div class="mb-4">
									...
									<i class="fas fa-paperclip"></i><a href="<?=base_url('uploads/email/'.@$result->attachment.'')?>" download><?=@$result->attachment?></a>
                                </div>
...
$(document).ready(function(){
	$("#productForm").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('email/editTemplate'); ?>',
		data: form_data,
		dataType:"json",
		contentType: false,
		cache: false,
