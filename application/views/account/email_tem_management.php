                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-8">
                        <div class="speaker-informations">
							...
							<a href="<?=base_url('email/create_template')?>" style="float: right;" class="btn btn-primary">Add Template</a>
								...
								<table  class="table table-bordered table-striped">
									...
									?>
											<tr>
												...
												<td>
													<a href="javascript:void(0);"  title="Duplicate" onclick="duplicate(<?=@$v->id?>)" ><i class="fa fa-clone"></i> </a>
                                                    <!--<a href="javascript:void(0);"  title="View" onclick="getInfo(<?=@$v->id?>)" ><i class="far fa-eye"></i> </a>-->													
                                                    <a href="<?=base_url('email/edit_template?tId='.base64_encode(@$v->id).'')?>"  title="Edit"  ><i class="far fa-edit"></i> </a>													
                                                    <a href="javascript:void(0);"  title="Delete" onclick="getDelete(<?=@$v->id?>)" ><i class="fa fa-trash"></i> </a>													
