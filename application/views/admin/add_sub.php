                     ...
                     <div class="card-body">    
                        <form id="submitform" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="pck_name"  id="pck_name"  autocomplete="off">
                            </div>
							<small id="pck_name_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Subscription Description</label>
                                <textarea type="text" class="form-control editor summermote" name="pck_desc"  id="pck_desc"  autocomplete="off"></textarea>
                            </div>
							...
							<div id="amount_type" style="display:none;">
								<div class="form-group mb-2" >
									<label class="fw-semibold  text-black">Subscription Amount</label>
									<input type="text" class="form-control" name="pck_amount"  id="pck_amount"  autocomplete="off">
								</div>
							...
							<div class="form-group mb-2">
								...
								<div class="row">
								  ...
								  <div class="col-sm-4" >
								      <input type="number" class="form-control" name="invite_limit"  id="invite_limit"  autocomplete="off">
								  </div>
                       ...
                       <div class="card-body">
                            <div class="row">
								 ...
								 <div class="col-lg-12 mb-3">
									...
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Subscription Amount</h6></label><p class="text-muted" id="package-amount"></p></div>
...
$(document).ready(function(){
	$("#submitform").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/subscription/addsub'); ?>',
