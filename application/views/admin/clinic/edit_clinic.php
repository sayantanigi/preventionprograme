                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="card shadow rounded">
                                <div class="card-body">
                                    <form action="<?= base_url('admin/clinic/edit_clinic/'.@$result->id)?>" method="POST" enctype="multipart/form-data">
                                        <div class="form-group mb-2">
                                            <label class="fw-semibold  text-black">Clinic Name *</label>
                                            <input type="text" class="form-control" name="clinic_name" id="clinic_name" required autocomplete="off" value="<?= @$result->name ?>">
                                        ...
                                        <div class="form-group mt-3 mb-2">
                                            ...
                                            <input type="hidden" name="clinic_id" value="<?= @$result->id; ?>">
                                        </div>
                                    </form>
                                </div>
                            </div>
