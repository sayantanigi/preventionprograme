                     ...
                     <div class="card-body">    
                        <form action="" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group mb-2">
                                <label class="fw-semibold  text-black">HC First Name</label>
                                <input type="text" class="form-control" name="fname"  id="fname" required autocomplete="off" value="<?=@$result->first_name?>">
                                <input type="hidden" class="form-control" name="id"  id="id" required autocomplete="off" value="<?=@$result->id?>">
                            </div>
							<small id="fname_error"></small>
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">HC Last Name</label>
							...
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">HC Email</label>
							...
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">HC Phone</label>
                                    ...
                                    <?php
									    if(@$clinic){
											foreach(@$clinic as $k => $v){
												echo "<option value='".$v->id."' ".((@$v->id == @$result->clinic) ? 'selected' : '').">".@$v->name."</option>";
											}
										}
									?>
                                </select>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="certificate"  id="certificate"  autocomplete="off" value="<?=@$result->certificate?>">
                            </div>
                            <small id="certificate_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Languages</label>
                                <input type="text" class="form-control" name="language"  id="language"  autocomplete="off" value="<?=@$result->language?>">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="max_client"  id="max_client"  autocomplete="off" value="<?=@$result->max_client?>">
                            </div>
                            <small id="max_client_error"></small>
