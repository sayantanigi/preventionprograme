...
;
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/globaladmin/editUser'); ?>',
		data: form_data,
		dataType:"json",
		contentType: false,
		cache: false,
		...
		success: function(data){
			if(data.status == 1){
				swal({title: "Sucess!", text: "<strong>"+data.message+"</strong>", type: "success", showConfirmButton: true, html:true}, function(){ window.location.href = "<?=base_url('admin/globaladmin')?>"});
