                     ...
                     <div class="card-body">    
                        <form id="submitform" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="plan_name"  id="plan_name"  autocomplete="off" required value="<?=@$result->name?>">
                                <input type="hidden"  name="id"  id="id"  required value="<?=@$result->id?>">
                            </div>
							...
							<div class="form-group mb-2">
								...
								<textarea class="form-control" name="plan_desc"  id="plan_desc"  autocomplete="off" required><?=@$result->description?></textarea>
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="plan_email"  id="plan_email"  autocomplete="off" required value="<?=@$result->email?>">
                            </div>
...
$(document).ready(function(){
	$("#submitform").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/healthplan/updateHealthplan'); ?>',
