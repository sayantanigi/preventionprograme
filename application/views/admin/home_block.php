						...
						<div class="row">
							<div class="col-sm-8">
								...
								<div class="form-group mb-2 files">
									...
									?>
									<img src="<?php echo !empty($aboutUs->image_1) ? base_url('uploads/about_us/'.$aboutUs->image_1.'') : base_url('uploads/noimage.jpg'); ?>" style="width: 30%;display:<?=(@$fileType == 1) ? 'block' : 'none';?>" id="blahImg" >
									
									<video id="blahVideo" style="width: 30%;display:<?=(@$fileType == 2) ? 'block' : 'none';?>" controls><source src="<?php echo !empty($aboutUs->image_1) ? base_url('uploads/about_us/'.$aboutUs->image_1.'') : base_url('uploads/noimage.jpg'); ?>"  ></video>
								</div><br/>
								...
								<div class="form-group mb-2 files">
									...
									?>
									<img src="<?php echo !empty($aboutUs->image_2) ? base_url('uploads/about_us/'.$aboutUs->image_2.'') : base_url('uploads/noimage.jpg'); ?>" style="width: 30%;display:<?=(@$fileType == 1) ? 'block' : 'none';?>" id="blahImg_2" >
									
									<video id="blahVideo" style="width: 30%;display:<?=(@$fileType == 2) ? 'block' : 'none';?>" controls><source src="<?php echo !empty($aboutUs->image_2) ? base_url('uploads/about_us/'.$aboutUs->image_2.'') : base_url('uploads/noimage.jpg'); ?>"  ></video>
								</div><br/>
...
$(document).ready(function(){
	$("#submitAboutus").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/cms/saveHomeblock'); ?>',
