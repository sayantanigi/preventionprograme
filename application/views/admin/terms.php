...
$(document).ready(function(){
	$("#submitAboutus").on('submit', function(e){
		...
		success: function(data){
			...
			if(data.status == 1)
			{
              swal({title: "Sucess!", text: "<strong>"+data.message+"</strong>", type: "success", showConfirmButton: true, html:true}, function(){ window.location.href = "<?=base_url('admin/cms/terms')?>"});
			}
