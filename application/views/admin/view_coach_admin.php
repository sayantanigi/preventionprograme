                        ...
                        <div class="row">
									...
									<div class="col-md-12">
										<div class="profile clearfix">                            
											<div class="image item" id="Cover-Image">
											    <img src="<?= !empty(@$user->cover_image) ? base_url('uploads/clinic/'.@$result->file.'') : base_url('uploads/bnr.jpg'); ?>" class="img-cover">
											</div>                           
											                    
											<div class="info">
												<p><span class="glyphicon glyphicon-globe"></span> <span class="title">Address:</span>  <?=@$result->address; ?></p>                                    									
											</div>                              
										</div>
									</div>
								</div>-->
                                <div class="col-lg-12 mb-3">
									...
									<div class="card rounded">
										<div class="card-body">
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>First Name</h6></label><p class="text-muted" id="first_name"><?=@$result->first_name; ?></p></div>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Last Name</h6></label><p class="text-muted" id="last_name"><?=@$result->last_name; ?></p></div>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Email</h6></label><p class="text-muted" id="recruiter_email"><?=@$result->email; ?></p></div>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Phone</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->phone; ?></p></div>
											<?php
												if(@$result->status == '1'){
													$status = 'Active'; 
												}else{
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Address</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->address; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>City</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->city; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Country</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->country; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Zipcode</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->zipcode; ?></p></div>
											
											<?php
											    $clinicName = '';
                                                if(@$result->clinic){
													$clinic = $this->Adminmodel->get_by('clinic', 'single', array('id' => @$result->clinic), '', 1);
													if($clinic->name){
														$clinicName = $clinic->name;
													}
												}
											?>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Clinic</h6></label><p class="text-muted" id="recruiter_phone"><?=@$clinicName; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Certificates</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->certificates; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Languages</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->languages; ?></p></div>
											
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Max Clients/Week</h6></label><p class="text-muted" id="recruiter_phone"><?=@$result->max_client; ?></p></div>
