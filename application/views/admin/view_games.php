							...
							<div class="row">
									...
									<div class="col-md-12">
										<div class="profile clearfix">                            
											<div class="image item" id="Cover-Image">
											    <img src="<?= !empty(@$gameInfo->game_image) ? base_url('uploads/games/'.@$gameInfo->game_image.'') : base_url('uploads/bnr.jpg'); ?>" class="img-cover">
											</div>                                                  
										</div>
									</div>
								</div>
								<div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Game Name</h6></label><p class="text-muted" id="game_name"><?=@$gameInfo->game_name; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Game Description</h6></label><p class="text-muted" id="game_description"><?=@$gameInfo->game_description; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Game Type</h6></label><p class="text-muted" id="game_type"><?=@$gameInfo->game_type; ?></p></div>
											
											<?php if($gameInfo->game_type == 'Tournament'){ ?>
												<div class="mt-3"> 
											...
											<?php } ?>
											<?php
											$sportName = $this->db->query("select sports_name from sports where id = ".$gameInfo->sport_id."")->row();
											//print_r($sportName);
											?>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Sport</h6></label><p class="text-muted" id="sport"><?=@$sportName->sports_name; ?></p></div>
											<?php
