...
<body>
    ...
    <?php if($this->session->userdata('logusertype') == '1') {
        $utype = 'participant';
    ...
    <nav class="sidebar">
        ...
        <ul class="nav-categories ul-base">
            <li>
                <a href="<?= base_url("$utype/dashboard")?>" id="Home1" class="Active">
                    <img src="<?= base_url('assets/users_assets/images/NavIcon1.png'); ?>" alt="">
                    <p>Home</p>
                </a>
            </li>
            <li>
                <a href="<?= base_url("$utype/clinic")?>" id="UpcomingEvents1">
                    <img src="<?= base_url('assets/users_assets/images/NavIcon2.png'); ?>" alt="">
                    <p>Manage Clinics</p>
                </a>
            </li>
            <li>
                <a href="<?= base_url("$utype/participants")?>" id="UpcomingEvents1">
                    <img src="<?= base_url('assets/users_assets/images/NavIcon2.png'); ?>" alt="">
                    <p>Manage Participants</p>
                </a>
            </li>
            <li>
                <a href="<?= base_url("$utype/providers")?>" id="ManageSubscription1">
        ...
        <div class="header-inner">
            <div class="header-first-inner">
                ...
                <div class="header-logo">
                    <a href="<?= base_url("$utype/dashboard")?>"><img alt="logo" src="<?= base_url('uploads/logos/' . @$settings->logo) ?>"></a>
                </div>
            ...
            <div class="header-menu">
                <ul class="ul-base">
                    <li>
                        <a href="<?= base_url("$utype/profile_settings")?>">Profile</a>
                    </li>
