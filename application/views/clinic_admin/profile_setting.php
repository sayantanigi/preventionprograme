<div class="container-fluid m-0 Section ProfileTab">
    <div class="row m-0 TabBar">
        <div class="TabBar">
            ...
            <a href="<?= base_url('clinic_admin/profile_settings')?>" id="Home">&nbsp;Profile</a>
            </div>
            ...
            <div class="row m-0" style="background: #fff;">
                <div class="col-lg-9 col-md-9 col-sm-12 UserProfileDataContainer">
                    <?php
                    if(!empty($userData->coverImage) && file_exists('uploads/coach/coverPic/'.$userData->coverImage)) { ?>
                    <img class="AddBanner" src="<?= base_url('uploads/coach/coverPic/'.$userData->coverImage); ?>" alt="">
                    <?php } else { ?>
                    <img class="AddBanner" src="<?= base_url('assets/users_assets/images/clinic_admin_cover.jpg'); ?>" alt="">
                    <?php } ?>
                    <div class="ProfileImageContainer">
                        <?php
                        if(!empty($userData->image) && file_exists('uploads/coach/profilePic/'.$userData->image)) { ?>
                        <img class="ProfileImage" src="<?= base_url('uploads/coach/profilePic/'.$userData->image); ?>" alt="">
                        <?php } else { ?>
                        <img class="ProfileImage" src="<?= base_url('assets/users_assets/images/clinic_admin_user.jpg'); ?>" alt="">
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" action="<?= base_url('clinic_admin/update_profile')?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            ?>
                            <img style="width: 55px; height: 55px; border-radius: 30px; position: absolute; bottom: 263px; float: left;" src="<?= base_url('uploads/coach/profilePic/'.$userData->image); ?>" />
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            ?>
                            <img style="width: 55px; height: 55px; border-radius: 30px; position: absolute; bottom: 263px; float: left;" src="<?= base_url('uploads/coach/coverPic/'.$userData->coverImage); ?>" />
    ...
    <div class="modal fade CustomModal" id="ChangePasswordModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" action="<?= base_url('clinic_admin/change_password')?>" method="post">
                        <div class="col-md-12 col-sm-12">
