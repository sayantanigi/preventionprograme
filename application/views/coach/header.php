...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="nav-categories ul-base">
            <li>
                <a href="<?= base_url('coach/dashboard')?>" id="Home1" class="Active">
        ...
        <div class="header-inner">
            <div class="header-first-inner">
                ...
                <div class="header-logo">
                    <a href="<?= base_url('coach/dashboard');?>"><img alt="logo" src="<?= base_url('uploads/logos/' . @$settings->logo) ?>"></a>
                </div>
            ...
            <div class="header-menu">
                <ul class="ul-base">
                    <li><a href="<?= base_url('coach/profile_settings')?>">Profile</a></li>
