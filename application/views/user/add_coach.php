                     ...
                     <div class="card-body">    
                        <form id="submitform" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group mb-2">
                                ...
                                <input type="number" class="form-control" name="phone"  id="phone"  autocomplete="off">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="clinical_interests"  id="clinical_interests"  autocomplete="off">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="specializations"  id="specializations"  autocomplete="off">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="max_week"  id="max_week"  autocomplete="off">
                            </div>
...
$(document).ready(function(){
	$("#submitform").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/users/addcoach'); ?>',
		data: form_data,
		dataType:"json",
		contentType: false,
		cache: false,
