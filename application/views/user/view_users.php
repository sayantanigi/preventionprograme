                                ...
                                <div class="col-lg-12 mb-3">
									...
									<div class="card rounded">
										<div class="card-body">
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Date Of Birth</h6></label><p class="text-muted" id="recruiter_phone"><?=@$dob; ?></p></div>
											
											<?php
											    if(@$user->health_etity){
													$entity = $this->db->query("select * from health_entity where id = ".@$user->health_etity."")->row(); 
													if($entity->name){
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Health Entity</h6></label><p class="text-muted" id="recruiter_phone"><?=@$entityName; ?></p></div>
											
											<?php
											    if(@$user->clinic){
													$clinic = $this->db->query("select * from clinic_admin where id = ".@$user->clinic."")->row(); 
													if($clinic->name){
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Clinic Admin</h6></label><p class="text-muted" id="recruiter_phone"><?=@$clinicName; ?></p></div>
											
											<?php
											    if(@$user->provider){
													$provider = $this->db->query("select * from provider where id = ".@$user->provider."")->row(); 
													if($provider->name){
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Provider</h6></label><p class="text-muted" id="recruiter_phone"><?=@$providerName; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Insurance Provider</h6></label><p class="text-muted" id="recruiter_phone"><?=@$user->insurance_provider; ?></p></div>
