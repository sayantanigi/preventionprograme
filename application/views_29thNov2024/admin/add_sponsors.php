                     ...
                     <div class="card-body">    
                        <form id="submitform" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="sponsor_name"  id="sponsor_name"  autocomplete="off" required>
                            </div>
							...
							<div class="form-group mb-2">
								...
								<textarea class="form-control" name="sponsor_desc"  id="sponsor_desc"  autocomplete="off" required></textarea>
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="sponsor_email"  id="sponsor_email"  autocomplete="off" required>
                            </div>
...
$(document).ready(function(){
	$("#submitform").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/sponsors/saveHealthplan'); ?>',
