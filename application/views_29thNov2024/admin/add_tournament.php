                     ...
                     <div class="card-body">    
                        <form id="submitform" method="post" enctype="multipart/form-data" >
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="tournament_name"  id="tournament_name"  autocomplete="off">
                            </div>
							<small id="game_name_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Tournament Description</label>
                                <textarea type="text" class="form-control editor summermote" name="tournament_description"  id="tournament_description"  autocomplete="off"></textarea>
                            </div>
...
$(document).ready(function(){
	$("#submitform").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/tournament/addTournament'); ?>',
