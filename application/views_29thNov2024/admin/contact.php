            ...
            <div class="col-xl-12">
               <div class="card custom-shadow rounded-lg border">
                  <div class="card-body">
                  	<div class="row">
	                  	<div class="col-sm-10">
	                     	<h4 class="card-title mb-4">Contact Query List</h4>
	                     </div>
                     ...
                     <div class="">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
								   ...
								   <?php if (is_array($contact) || is_object($contact)) { ?>
										<?php foreach ($contact as $key => $v): ?>
											<tr>
												<td ><?= $key+1 ?></td>
												...
												<td class="text-center">
													...
													<a href="<?= base_url('admin/contact/send_mail/'.$v->id) ?>" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" title="Send Mail" >
   ...
   function dealDetail(dealId) {
	...
	function deleteDeals(dealId) 
	{
		swal({
			...
			if (isConfirm) {
				window.location.href = '<?=base_url();?>admin/contact/delete?id='+dealId;
			}
		});
	}
