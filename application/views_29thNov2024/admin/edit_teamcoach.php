                     ...
                     <div class="card-body">    
                        <form id="submitform" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="fname"  id="fname" required autocomplete="off" value="<?=@$user->fname?>">
                            </div>
							<small id="fname_error"></small>
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Last Name</label>
                                <input type="text" class="form-control" name="lname"  id="lname" required autocomplete="off" value="<?=@$user->lname?>">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="number" class="form-control" name="phone"  id="phone"  autocomplete="off" value="<?=@$user->phone?>">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="address" id="autocomplete" value="<?=@$user->address?>">
								<input type="hidden" placeholder="Near"  name="latitude" id="latitude" value="<?=@$user->latitude?>">
								<input type="hidden" placeholder="Near" name="longitude" id="longitude" value="<?=@$user->longitude?>">
							...
							<div class="form-group mb-2">
								<div class="row">
									...
									<label class="fw-semibold  text-black">Zipcode</label>
								        <input type="text" class="form-control" name="pincode" id="pincode" value="<?=@$user->zipcode?>">
								    </div>
							...
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Select Health Entity</label>
                                <select class="form-control" name="health_etity" required id="health_etity">
                                    <option value="">Select Health Entity</option>
                                    <?php
									    if(@$entity){
											foreach(@$entity as $k => $v){
												echo '<option value="'.@$v->id.'" '.((@$v->id == @$user->health_etity) ? 'selected' : '').'>'.@$v->name.'</option>';
											}
										}
									?>
                                </select>
							...
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Select Clinic Admin</label>
                                <select class="form-control" name="clinic" required id="clinic">
                                    <option value="">Select Clinic</option>
									<?php
									    if(@$clinicAdmin){
											foreach(@$clinicAdmin as $k => $v){
												echo '<option value="'.@$v->id.'" '.((@$v->id == @$user->clinic) ? 'selected' : '').'>'.@$v->name.'</option>';
											}
										}
									?>
							...
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Back Ground With Degrees</label>
                                <input type="text" class="form-control" name="degree"  id="degree"  autocomplete="off" value="<?=@$user->degree?>">
                            </div>
                            <small id="degree_error"></small>
							
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Clinical Interests</label>
                                <input type="text" class="form-control" name="clinical_interests"  id="clinical_interests"  autocomplete="off" value="<?=@$user->clinical_interests?>">
                            </div>
                            <small id="clinical_interests_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Languages</label>
                                <input type="text" class="form-control" name="languages"  id="languages"  autocomplete="off" value="<?=@$user->languages?>">
                            </div>
                            <small id="languages_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Specializations</label>
                                <input type="text" class="form-control" name="specializations"  id="specializations"  autocomplete="off" value="<?=@$user->specializations?>">
                            </div>
                            <small id="specializations_error"></small>
							
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Certificates</label>
                                <input type="text" class="form-control" name="certificates"  id="certificates"  autocomplete="off" value="<?=@$user->certificates?>">
                            </div>
                            <small id="certificates_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Max Clients/Week</label>
                                <input type="text" class="form-control" name="max_week"  id="max_week"  autocomplete="off" value="<?=@$user->max_week?>">
                            </div>
                            <small id="max_week_error"></small>
							  
							
							<!--<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Date Of Birth</label>
                        ...
                        <div class="card-body">
							...
							<div class="container">
										...
										<div class="profile clearfix">                            
											...
											<div class="user clearfix">
												<div class="avatar item" id="item">
													<img src="<?= !empty(@$user->image) ? base_url('uploads/profile/'.@$user->image.'') : base_url('uploads/bnr.jpg'); ?>" class="img-thumbnail img-profile" id="blah">
												</div>                                
                                ...
                                <div class="col-lg-12 mb-3">
									...
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Email</h6></label><p class="text-muted" id="individual_email"><?=@$user->email; ?></p></div>
...
$(document).ready(function(){
	$("#submitform").on('submit', function(e){
		...
		var clinical_interests = $('#clinical_interests').val(); 
		...
		form_data.append("clinical_interests", clinical_interests);
		form_data.append("languages", languages);
		form_data.append("specializations", specializations);
		form_data.append("certificates", certificates);
		form_data.append("max_week", max_week);
		form_data.append("userId", userId);
		form_data.append("health_etity", health_etity);
		form_data.append("clinic", clinic);
		
		$.ajax({
		type: 'POST',
		url: '<?php echo base_url('admin/users/edit_team_coach'); ?>',
		data: form_data,
		dataType:"json",
		contentType: false,
		cache: false,
