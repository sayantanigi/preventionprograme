                  ...
                  <div class="card-body">
                  	<div class="row">
	                     ...
	                     <div class="col-sm-2 text-end" style="padding-left: 54px;">
	                     	 <a href="<?=base_url('admin/recruiter/add')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Add Recruiter</a>
	                     </div>
	                  </div>   	
                     <div class="">
										...
										<?php foreach ($userlist as $key => $v): ?>
											<tr>
												...
												<td class="text-center">
												    <!--<a href="<?= base_url('admin/recruiter/recruiter-profile/'.@$v->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="View">
														<i class="fa fa-user"></i>
													</a>-->
													<a href="<?= base_url('admin/recruiter/edit/'.$v->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit">
														<i class="fas fa-edit"></i>
													</a>
													
													<a href="<?= base_url('admin/recruiter/view/'.@$v->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="View">
														<i class="fa fa-eye"></i>
													</a>
   ...
   function dealDetail(dealId) {
	...
	function deleteDeals(dealId) 
	{
		swal({
			...
			if (isConfirm) {
				window.location.href = '<?= base_url('admin/users/deleteRecruiter/') ?>'+dealId
			}
		});
	}
