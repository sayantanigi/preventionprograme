<style>
	...
	.sa-confirm-button-container button{
		...
		color:black !important;
		box-shadow : rgb(255 255 255 / 0%) 0px 0px 2px, rgb(221 201 201 / 0%) 0px 0px 0px 1px inset !important;
   ...
   function dealDetail(dealId) {
	...
	function deleteDeals(dealId) 
	{
		swal({
			...
			if (isConfirm) {
				window.location.href = '<?= base_url('admin/users/deleteTeamcoach/') ?>'+dealId
			}
		});
	}
