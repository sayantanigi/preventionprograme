                  ...
                  <div class="card-body">
                  	<div class="row">
	                     ...
	                     <div class="col-sm-2 text-end" style="padding-left: 54px;">
	                     	<a href="<?=base_url('admin/users/add')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Add Participants</a>
	                     </div>
	                  </div>   	
                     <div class="">
										...
										<?php foreach ($userlist as $key => $v): ?>
											...
											<tr>
												...
												<td class="text-center">
												    <a href="<?= base_url('admin/users/edit/'.$v->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit">
