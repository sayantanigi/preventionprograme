            ...
            <div class="d-flex">
               ...
               <div class="dropdown d-inline-block user-dropdown">
                  <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                     data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <img class="rounded-circle header-profile-user" src="<?=!empty(@$profileData->image) ? base_url('uploads/profile/'.@$profileData->image.'') : base_url('uploads/unnamed.jpg');?>"
                     alt="Header Avatar">
                  </button>
                  <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                     <div class="p-3">
                        <div class="row align-items-center">
                           <div class="col">
                              <h6 class="m-0">Hi, <?=@$profileData->fname.' '.@$profileData->lname?> (<?=@$roleName?>)</h6>
                     ...
                     <div data-simplebar style="max-height: 230px;">
                        <!-- item-->
                        <a href="<?=base_url('user/profile') ?>" class="text-reset notification-item">
                     ...
                     <div class="pt-2 border-top">
                        <div class="d-grid">
                           <a class="btn btn-sm btn-link font-size-14 text-center" href="<?= base_url('user/login/logout') ?>">
