										...
										<div class="panel-body">
											...
											<div class="row">
												...
												<div class="col-md-7">
													...
													<form action="<?=base_url('web_view_stripe_payment')?>" method="POST" id="paymentFrm">
													
														<div class="row">
															<div class="col-xs-12">
																<div class="form-group">
																	<label class="fw-semibold">NAME OF CARD HOLDER</label>
																	<input type="text" class="form-control" name="card_name" id="card_name" placeholder="Name of Card Holder" value="">
																</div>
															
																<input type="hidden" name="subId" id="subId" value="<?= @$subId ?>" >
																<input type="hidden" name="total" id="total" value="<?= @$amount ?>" required="">
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" name="card_address" id="card_address" placeholder="Full Address" value="">
																</div>
														...
														<div class="row">
															<div class="col-xs-4 col-md-4">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" placeholder="Country" name="card_country" id="card_country" value="">
																</div>
															</div>
															<div class="col-xs-4 col-md-4 pull-right">
																<div class="form-group">
																	<label class="fw-semibold">STATE</label>
																	<input type="text" class="form-control" placeholder="State" name="card_state" id="card_state" value="">
																</div>
															...
															<div class="col-xs-4 col-md-4 pull-right">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" placeholder="City" name="card_city" id="card_city" value="">
																</div>
															</div>
														</div><br>
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" placeholder="Zipcode" name="card_zipcode" id="card_zipcode" value="">
																</div>
